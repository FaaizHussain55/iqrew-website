...
export default function FAQ() {
  ...
  return (
    <div className="faq-page">
      <section className="curve-top-section orange-curve faq1" aria-labelledby="faq-title">
      ...
      <section className="faq2" aria-label="FAQ Content">
        <div className="container">
                    ...
                    <dt className="faq-question-wrapper">
                      ...
                      >
                        <span className="faq-icon" aria-hidden="true">
                          {isOpen ? <img src={iconFaqMinus} alt="" /> : <img src={iconFaqPlus} alt="" />}
                        </span>
